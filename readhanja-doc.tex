...
\def\readndo#1{\bigbreak #1\texttt{\detokenize{#1}}\par}
...
\endgroup
\readndo{\readhanjalocate{post} \directlua{readhanja.draft=true}}\greatlearning
\readndo{\readhanjalocate{pre} \readhanjaraise{0.5ex}}\greatlearning
\end{readhanja}
